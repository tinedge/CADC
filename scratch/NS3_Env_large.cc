...
main (int argc, char *argv[])
{
  ...
  for (uint32_t buildingIndex = 0; buildingIndex < numBlocks; buildingIndex++)
    {
      ...
      */
      std::pair<Box, std::list<Box> > pairBuildings = GenerateBuildingBounds (100, 300, 20, 30, maxBuildingSize, m_previousBlocks);
  ...
  for (uint32_t buildingIndex = 0; buildingIndex < numBlocks; buildingIndex++)
    {
      ...
      * position [3]: coordinates for y max
      */
      std::pair<Box, std::list<Box> > pairBuildings = GenerateBuildingBounds (100, 300, 370, 380, maxBuildingSize, m_previousBlocks);
      m_previousBlocks = std::get<1> (pairBuildings);
      Box box = std::get<0> (pairBuildings);
      Ptr<UniformRandomVariable> randomBuildingZ = CreateObject<UniformRandomVariable> ();
      randomBuildingZ->SetAttribute ("Min",DoubleValue (1.6));
  ...
  for (uint32_t buildingIndex = 0; buildingIndex < numBlocks; buildingIndex++)
    {
      ...
      * position [3]: coordinates for y max
      */
      std::pair<Box, std::list<Box> > pairBuildings = GenerateBuildingBounds (20, 30, 100, 300, maxBuildingSize, m_previousBlocks);
      m_previousBlocks = std::get<1> (pairBuildings);
      Box box = std::get<0> (pairBuildings);
      Ptr<UniformRandomVariable> randomBuildingZ = CreateObject<UniformRandomVariable> ();
      randomBuildingZ->SetAttribute ("Min",DoubleValue (1.6));
  ...
  for (uint32_t buildingIndex = 0; buildingIndex < numBlocks; buildingIndex++)
    {
      ...
      * position [3]: coordinates for y max
      */
      std::pair<Box, std::list<Box> > pairBuildings = GenerateBuildingBounds (370, 380, 100, 300, maxBuildingSize, m_previousBlocks);
      m_previousBlocks = std::get<1> (pairBuildings);
      Box box = std::get<0> (pairBuildings);
      Ptr<UniformRandomVariable> randomBuildingZ = CreateObject<UniformRandomVariable> ();
      randomBuildingZ->SetAttribute ("Min",DoubleValue (1.6));
  ...
  xPos2->SetAttribute ("Min", DoubleValue (50));
  xPos2->SetAttribute ("Max", DoubleValue (350));
  allocator2->SetX (xPos2);
  Ptr<UniformRandomVariable> yPos2 = CreateObject<UniformRandomVariable> ();
  yPos2->SetAttribute ("Min", DoubleValue (50.0));
  yPos2->SetAttribute ("Max", DoubleValue (150.0));
  ...
  ueMobility2_1.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             "Bounds", RectangleValue (Rectangle (50, 350, 80, 150)),
  ...
  ueMobility2_3.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             ...
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  for (int i= 2 ; i < 4 ; i++)
  ueMobility2_3.Install (ueNodes.Get(i));
  ...
  ueMobility2_4.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             ...
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  // for (int i= 3 ; i < 6 ; i++)
  ueMobility2_4.Install (ueNodes.Get(4));
  ...
  ueMobility2_5.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             ...
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  for (int i= 5 ; i < 7 ; i++)
  ueMobility2_5.Install (ueNodes.Get(i));
  ...
  ueMobility2_6.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             ...
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  ueMobility2_6.Install (ueNodes.Get(7));
  ...
  ueMobility2_7.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             ...
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  ueMobility2_7.Install (ueNodes.Get(8));
  ...
  ueMobility2_7_1.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             ...
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  ueMobility2_7_1.Install (ueNodes.Get(9));
  ...
  ueMobility2_8.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             ...
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  ueMobility2_8.Install (ueNodes.Get(10));
  ...
  ueMobility2_9.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             ...
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  ueMobility2_9.Install (ueNodes.Get(11));
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  xPos3->SetAttribute ("Min", DoubleValue (50.0));
  xPos3->SetAttribute ("Max", DoubleValue (350.0));
  allocator3->SetX (xPos3);
  Ptr<UniformRandomVariable> yPos3 = CreateObject<UniformRandomVariable> ();
  yPos3->SetAttribute ("Min", DoubleValue (250.0));
  yPos3->SetAttribute ("Max", DoubleValue (350.0));
  ...
  ueMobility3_1.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             "Bounds", RectangleValue (Rectangle (50, 350, 250, 320)),
                             "Speed", StringValue ("ns3::ConstantRandomVariable[Constant=20]"),
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  ueMobility3_1.Install (ueNodes.Get(12));
  ...
  ueMobility3_2.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             ...
                             "Speed", StringValue ("ns3::ConstantRandomVariable[Constant=25]"),
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  ueMobility3_2.Install (ueNodes.Get(13));
  ...
  ueMobility3_3.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             ...
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  for (int i=14 ; i < 16 ; i++)
  ueMobility3_3.Install (ueNodes.Get(i));
  ...
  ueMobility3_4.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             ...
                             "Speed", StringValue ("ns3::ConstantRandomVariable[Constant=35]"),
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  ueMobility3_4.Install (ueNodes.Get(16));
  ...
  ueMobility3_5.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             ...
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  for (int i=17 ; i < 19 ; i++)
  ueMobility3_5.Install (ueNodes.Get(i));
  ...
  ueMobility3_6.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             ...
                             "Speed", StringValue ("ns3::ConstantRandomVariable[Constant=45]"),
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  ueMobility3_6.Install (ueNodes.Get(19));
  ...
  ueMobility3_7.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             ...
                             "Speed", StringValue ("ns3::ConstantRandomVariable[Constant=50]"),
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  ueMobility3_7.Install (ueNodes.Get(20));
  ...
  ueMobility3_7_1.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             ...
                             "Speed", StringValue ("ns3::ConstantRandomVariable[Constant=15]"),
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  ueMobility3_7_1.Install (ueNodes.Get(21));
  ...
  ueMobility3_8.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             ...
                             "Speed", StringValue ("ns3::ConstantRandomVariable[Constant=55]"),
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  ueMobility3_8.Install (ueNodes.Get(22));
  ...
  ueMobility3_9.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             ...
                             "Speed", StringValue ("ns3::ConstantRandomVariable[Constant=60]"),
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  ueMobility3_9.Install (ueNodes.Get(23));
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  xPos4->SetAttribute ("Min", DoubleValue (250));
  xPos4->SetAttribute ("Max", DoubleValue (350));
  allocator4->SetX (xPos4);
  Ptr<UniformRandomVariable> yPos4 = CreateObject<UniformRandomVariable> ();
  yPos4->SetAttribute ("Min", DoubleValue (50));
  yPos4->SetAttribute ("Max", DoubleValue (350));
  ...
  ueMobility4_1.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             "Bounds", RectangleValue (Rectangle (250, 320, 50, 350)),
                             "Speed", StringValue ("ns3::ConstantRandomVariable[Constant=20]"),
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  ueMobility4_1.Install (ueNodes.Get(24));
  ...
  ueMobility4_2.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             ...
                             "Speed", StringValue ("ns3::ConstantRandomVariable[Constant=25]"),
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  ueMobility4_2.Install (ueNodes.Get(25));
  ...
  ueMobility4_3.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             ...
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  for (int i=26 ; i < 28 ; i++)
  ueMobility4_3.Install (ueNodes.Get(i));
  ...
  ueMobility4_4.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             ...
                             "Speed", StringValue ("ns3::ConstantRandomVariable[Constant=35]"),
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  ueMobility4_4.Install (ueNodes.Get(28));
  ...
  ueMobility4_5.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             ...
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  for (int i=29 ; i < 31 ; i++)
  ueMobility4_5.Install (ueNodes.Get(i));
  ...
  ueMobility4_6.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             ...
                             "Speed", StringValue ("ns3::ConstantRandomVariable[Constant=45]"),
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  ueMobility4_6.Install (ueNodes.Get(31));
  ...
  ueMobility4_7.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             ...
                             "Speed", StringValue ("ns3::ConstantRandomVariable[Constant=50]"),
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  ueMobility4_7.Install (ueNodes.Get(32));
  ...
  ueMobility4_7_1.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             ...
                             "Speed", StringValue ("ns3::ConstantRandomVariable[Constant=15]"),
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  ueMobility4_7_1.Install (ueNodes.Get(33));
  ...
  ueMobility4_8.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             ...
                             "Speed", StringValue ("ns3::ConstantRandomVariable[Constant=55]"),
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  ueMobility4_8.Install (ueNodes.Get(34));
  ...
  ueMobility4_9.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             ...
                             "Speed", StringValue ("ns3::ConstantRandomVariable[Constant=60]"),
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  ueMobility4_9.Install (ueNodes.Get(35));
...
//////////////////////////////////////////////////////////////////////////////////////////////////////
  ...
  xPos5->SetAttribute ("Min", DoubleValue (50.0));
  xPos5->SetAttribute ("Max", DoubleValue (150.0));
  allocator5->SetX (xPos5);
  Ptr<UniformRandomVariable> yPos5 = CreateObject<UniformRandomVariable> ();
  yPos5->SetAttribute ("Min", DoubleValue (50.0));
  yPos5->SetAttribute ("Max", DoubleValue (350.0));
  ...
  ueMobility5_1.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             "Bounds", RectangleValue (Rectangle (80, 150, 50, 350)),
                             "Speed", StringValue ("ns3::ConstantRandomVariable[Constant=20]"),
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  ueMobility5_1.Install (ueNodes.Get(36));
  ...
  ueMobility5_2.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             ...
                             "Speed", StringValue ("ns3::ConstantRandomVariable[Constant=25]"),
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  ueMobility5_2.Install (ueNodes.Get(37));
  ...
  ueMobility5_3.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             ...
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  for (int i=38; i < 40 ; i++)
  ueMobility5_3.Install (ueNodes.Get(i));
  ...
  ueMobility5_4.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             ...
                             "Speed", StringValue ("ns3::ConstantRandomVariable[Constant=35]"),
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  ueMobility5_4.Install (ueNodes.Get(40));
  ...
  ueMobility5_5.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             ...
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  for (int i=41; i < 43 ; i++)
  ueMobility5_5.Install (ueNodes.Get(i));
  ...
  ueMobility5_6.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             ...
                             "Speed", StringValue ("ns3::ConstantRandomVariable[Constant=45]"),
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  ueMobility5_6.Install (ueNodes.Get(43));
  ...
  ueMobility5_7.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             ...
                             "Speed", StringValue ("ns3::ConstantRandomVariable[Constant=50]"),
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  ueMobility5_7.Install (ueNodes.Get(44));
  ...
  ueMobility5_7_1.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             ...
                             "Speed", StringValue ("ns3::ConstantRandomVariable[Constant=15]"),
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  ueMobility5_7_1.Install (ueNodes.Get(45));
  ...
  ueMobility5_8.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             ...
                             "Speed", StringValue ("ns3::ConstantRandomVariable[Constant=55]"),
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  ueMobility5_8.Install (ueNodes.Get(46));
  ...
  ueMobility5_9.SetMobilityModel ("ns3::RandomDirection2dMobilityModel",
                             ...
                             "Speed", StringValue ("ns3::ConstantRandomVariable[Constant=60]"),
                             "Pause", StringValue ("ns3::ConstantRandomVariable[Constant=1]"));
  ueMobility5_9.Install (ueNodes.Get(47));
  ...
  Ptr<ConstantPositionMobilityModel> m0 = DynamicCast<ConstantPositionMobilityModel>(ueNodes.Get(48)->GetObject<MobilityModel> ());	  
  Ptr<ConstantPositionMobilityModel> m1 = DynamicCast<ConstantPositionMobilityModel>(ueNodes.Get(49)->GetObject<MobilityModel> ());	
  Ptr<ConstantPositionMobilityModel> m2 = DynamicCast<ConstantPositionMobilityModel>(ueNodes.Get(50)->GetObject<MobilityModel> ());	
  Ptr<ConstantPositionMobilityModel> m3 = DynamicCast<ConstantPositionMobilityModel>(ueNodes.Get(51)->GetObject<MobilityModel> ());	
  Ptr<ConstantPositionMobilityModel> m4 = DynamicCast<ConstantPositionMobilityModel>(ueNodes.Get(52)->GetObject<MobilityModel> ());	
  Ptr<ConstantPositionMobilityModel> m5 = DynamicCast<ConstantPositionMobilityModel>(ueNodes.Get(53)->GetObject<MobilityModel> ());	
  Ptr<ConstantPositionMobilityModel> m6 = DynamicCast<ConstantPositionMobilityModel>(ueNodes.Get(54)->GetObject<MobilityModel> ());	
  Ptr<ConstantPositionMobilityModel> m7 = DynamicCast<ConstantPositionMobilityModel>(ueNodes.Get(55)->GetObject<MobilityModel> ());	
  Ptr<ConstantPositionMobilityModel> m8 = DynamicCast<ConstantPositionMobilityModel>(ueNodes.Get(56)->GetObject<MobilityModel> ());	
  Ptr<ConstantPositionMobilityModel> m9 = DynamicCast<ConstantPositionMobilityModel>(ueNodes.Get(57)->GetObject<MobilityModel> ());	
  Ptr<ConstantPositionMobilityModel> m10 = DynamicCast<ConstantPositionMobilityModel>(ueNodes.Get(58)->GetObject<MobilityModel> ());	
  Ptr<ConstantPositionMobilityModel> m11 = DynamicCast<ConstantPositionMobilityModel>(ueNodes.Get(59)->GetObject<MobilityModel> ());	

  
 
m0->SetPosition(Vector(0,0,1.6));
m1->SetPosition(Vector(400,0,1.6)); 
m2->SetPosition(Vector(0,400,1.6)); 
m3->SetPosition(Vector(400,400,1.6)); 

m4->SetPosition(Vector(0,0,1.6));
m5->SetPosition(Vector(400,0,1.6)); 
m6->SetPosition(Vector(0,400,1.6)); 
m7->SetPosition(Vector(400,400,1.6)); 

m8->SetPosition(Vector(0,0,1.6));
m9->SetPosition(Vector(400,0,1.6)); 
m10->SetPosition(Vector(0,400,1.6)); 
m11->SetPosition(Vector(400,400,1.6)); 
