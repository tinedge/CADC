...
if __name__ == "__main__" :
    ...
    # Cluster
    cluster_list = [ [0,1,3,4], [6,7,8], [2,5] ]
    ...
    Q1_Mlb = np.array(csv2list("/home/mnc/CADC/Qtable/large/Qtable1_QLB_large.csv"))
    Q2_Mlb = np.array(csv2list("/home/mnc/CADC/Qtable/large/Qtable2_QLB_large.csv"))
    Q3_Mlb = np.array(csv2list("/home/mnc/CADC/Qtable/large/Qtable3_QLB_large.csv"))
    Q4_Mlb = np.array(csv2list("/home/mnc/CADC/Qtable/large/Qtable4_QLB_large.csv"))
    Q5_Mlb = np.array(csv2list("/home/mnc/CADC/Qtable/large/Qtable5_QLB_large.csv"))
    Q6_Mlb = np.array(csv2list("/home/mnc/CADC/Qtable/large/Qtable6_QLB_large.csv"))
    Q7_Mlb = np.array(csv2list("/home/mnc/CADC/Qtable/large/Qtable7_QLB_large.csv"))
    Q8_Mlb = np.array(csv2list("/home/mnc/CADC/Qtable/large/Qtable8_QLB_large.csv"))
    Q9_Mlb = np.array(csv2list("/home/mnc/CADC/Qtable/large/Qtable9_QLB_large.csv"))

    Q1_Mro = np.array(csv2list("/home/mnc/CADC/Qtable/large/Qtable1_QMRO_large.csv"))
    Q2_Mro = np.array(csv2list("/home/mnc/CADC/Qtable/large/Qtable2_QMRO_large.csv"))
    Q3_Mro = np.array(csv2list("/home/mnc/CADC/Qtable/large/Qtable3_QMRO_large.csv"))
    Q4_Mro = np.array(csv2list("/home/mnc/CADC/Qtable/large/Qtable4_QMRO_large.csv"))
    Q5_Mro = np.array(csv2list("/home/mnc/CADC/Qtable/large/Qtable5_QMRO_large.csv"))
    Q6_Mro = np.array(csv2list("/home/mnc/CADC/Qtable/large/Qtable6_QMRO_large.csv"))
    Q7_Mro = np.array(csv2list("/home/mnc/CADC/Qtable/large/Qtable7_QMRO_large.csv"))
    Q8_Mro = np.array(csv2list("/home/mnc/CADC/Qtable/large/Qtable8_QMRO_large.csv"))
    Q9_Mro = np.array(csv2list("/home/mnc/CADC/Qtable/large/Qtable9_QMRO_large.csv"))
        ...
        for j in range(max_env_steps): 
            ...
            for k in range(9) :
                if (env_actions_coordinator[k] == 0) :
                    ...
                    with open ("/home/mnc/SLC2/sonfunc_operate2.txt","a") as f:
                        f.write("BS {} : MLB: O MRO : O\n".format(k+1))

                elif (env_actions_coordinator[k] == 1) :    
                    print(" MRO : X  MLB : O ")

                    with open ("/home/mnc/SLC2/sonfunc_operate2.txt","a") as f:
                        f.write("BS {} : MLB: X MRO : O\n".format(k+1))

                elif (env_actions_coordinator[k] == 2) :    
                    print(" MRO : O MLB : X  ")

                    with open ("/home/mnc/SLC2/sonfunc_operate2.txt","a") as f:
                        f.write("BS {} : MLB: O MRO : X\n".format(k+1))

                elif (env_actions_coordinator[k] == 3) :
                    print(" MRO : X MLB : X  ")

                    with open ("/home/mnc/SLC2/sonfunc_operate2.txt","a") as f:
                        f.write("BS {} : MLB: X MRO : X\n".format(k+1))


                print("After Coordination, BS {} actions HOM: {}  TTT: {}".format(k+1, env_actions_chose[2*k+10], env_actions_chose[2*k+9]))
            ...
            CurrentTtt = np.array(new_env_actions_Mro[0::2][:9]) #HOM
            CurrentHom = np.array(new_env_actions_Mro[1::2][:9]) #TTT

            PreviousCio = np.array(env_actions[:9]) # previous_CIO
            PreviousTtt = np.array(env_actions[9::2][:9]) # previous_HOM        
            PreviousHom = np.array(env_actions[10::2][:9]) # previous_TTT
            ...
            reward_weight_MLB = 0.2 
            reward_weight_MRO = 0.8
